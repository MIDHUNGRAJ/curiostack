      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold gradient-text">CurioStack</span>
            </Link>
            <p className="text-muted-foreground mb-4 max-w-md">
              Stay updated with the latest technology and business news. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/api-services" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  API Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blog?category=AI" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  AI & Machine Learning
                </Link>
              </li>
              <li>
                <Link href="/blog?category=Technology" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Technology
                </Link>
              </li>
              <li>
                <Link href="/blog?category=Business" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Business
                </Link>
              </li>
              <li>
                <Link href="/blog?category=Cybersecurity" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Cybersecurity
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-border/40 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2024 CurioStack. All rights reserved.
          </p>
